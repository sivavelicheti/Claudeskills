...
FIRST ACTION, before reading any code: invoke the `superpowers:test-driven-development`
skill and follow its RED-phase discipline exactly. If the skill is unavailable, state
that in your report and follow the rules below.
